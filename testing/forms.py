...
class SPFRecordForm(forms.Form):
    policy = forms.ChoiceField(choices=(('-all', 'Strict'), ('?all', 'Neutral'), ('~all', 'Soft fail')),
                               help_text='Select policy for servers not listed in your SPF record')
    hosts = forms.CharField(max_length=200, help_text='Please write all hosts that are allowed to send mails for your '
