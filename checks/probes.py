...
from checks.categories import WebTlsHttpsExists
from checks.models import ConnectionTest
from checks.models import DomainTestDnssec
from checks.models import DomainTestIpv6
...
from checks.models import WebTestAppsecpriv
from checks.models import WebTestRpki
from checks.models import WebTestTls
from checks.scoring import STATUS_ERROR
from checks.scoring import STATUS_FAIL
from checks.scoring import STATUS_GOOD_NOT_TESTED
...
from checks.scoring import STATUSES_HTML_CSS_TEXT_MAP
...
class Probe:
    ...
    def _verdict(self, report):
        ...
        has_mandatory = False
        has_optional = False
        for name, _subtest in report.items():
    ...
    def check_results(self, dname, remote_addr) -> ProbeTaskResult:
        ...
        """
        return dispatcher.check_results(
            dname, self.taskset, remote_addr, get_results=False
        )
    ...
    def rated_results_by_model(self, modelobj):
        ...
        max_score, total_score, verdict, text_verdict = self.get_scores_and_verdict(
            modelobj
        )
